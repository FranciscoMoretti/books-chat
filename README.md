<a href="https://chat.vercel.ai/">
  ...
  <h1 align="center">Books AI Chatbot</h1>
</a>
...
You can deploy your own version of the Books AI Chatbot to Vercel with one click:
...
You will need to use the environment variables [defined in `.env.example`](.env.example) to run Books AI Chatbot. It's recommended you use [Vercel Environment Variables](https://vercel.com/docs/projects/environment-variables) for this, but a `.env` file is all that is necessary.
